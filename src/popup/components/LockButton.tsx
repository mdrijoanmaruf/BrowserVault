    ...
    >
      <div className="flex items-center gap-3.5">
        ...
        <div className="w-[56px] h-[56px] flex-shrink-0 flex items-center justify-center rounded-full bg-[#f0f5ff]">
          {isLoading ? (
            <svg className="animate-spin w-6 h-6 text-[#5a8bf7]" fill="none" viewBox="0 0 24 24">
              <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="3" strokeOpacity="0.25"/>
              <path d="M12 2a10 10 0 0110 10" stroke="currentColor" strokeWidth="3" strokeLinecap="round"/>
            </svg>
          ) : (
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#5a8bf7" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
              <rect x="5" y="11" width="14" height="10" rx="2" ry="2"></rect>
              <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
        ...
        <div className="flex flex-col items-start text-left">
          ...
          <span className="text-[12px] font-medium text-[#5a6a85] leading-[1.3]">
            Secure your browser and<br/>protect your data
          </span>
        </div>
      </div>
